<template>
  <div class="add-goods">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <!-- <el-form-item label="常用选项">
    <el-checkbox-group v-model="form.choose">
      <el-checkbox label="美食/餐厅线上活动" name="one"></el-checkbox>
      <el-checkbox label="地推活动" name="two"></el-checkbox>
      <el-checkbox label="线下主题活动" name="three"></el-checkbox>
      <el-checkbox label="单纯品牌曝光" name="four"></el-checkbox>
    </el-checkbox-group>
  </el-form-item> -->
...
export default {
  ...
  methods: {
    ...
    goBack() {
      this.$confirm("确定放弃发布商品并返回主页吗?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
    ...
    submit() {
      this.setImgs();
      this.$axios
        .post("/user/publish-product", this.form, {
